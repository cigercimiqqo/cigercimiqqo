...
export function GalleryPreview() {
  ...
  const images =
    galleryImages.length >= 5
      ...
      : [
          { src: 'gradient', span: 'col-span-2 row-span-2' },
          { src: 'gradient', span: '' },
          { src: 'gradient', span: '' },
          { src: 'gradient', span: '' },
          { src: 'gradient', span: '' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 auto-rows-[200px] md:auto-rows-[240px]">
          {images.map((img, i) => (
            ...
            >
              {img.src === 'gradient' ? (
                <div className="absolute inset-0 bg-gradient-to-br from-surface-800 to-surface-900 transition-transform duration-700 group-hover:scale-105" />
              ) : (
                <div
